      ...
      <article className="mx-auto w-full max-w-3xl flex-1 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 rounded-sm border border-zinc-300/30 bg-secondary/5 p-5 sm:p-6">
          ...
          <Link
            ...
            className="mt-5 inline-flex h-11 items-center justify-center rounded-sm bg-primary px-5 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90"
          >
            Beratung anfragen
          </Link>
        </div>

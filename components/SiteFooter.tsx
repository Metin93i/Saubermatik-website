  ...
  return (
    <footer className="mt-auto border-t border-foreground/10 bg-primary text-primary-foreground">
      <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 py-12 sm:grid-cols-2 sm:px-6 lg:grid-cols-3 lg:px-8">
        <div>
          <p className="text-base font-semibold">Saubermatik</p>
        ...
        <div>
          <p className="text-sm font-semibold">Standorte</p>
          <ul className="mt-3 space-y-2 text-sm text-primary-foreground/85">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 text-xs text-primary-foreground/70 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          <p>© {new Date().getFullYear()} Saubermatik Gebäudereinigung</p>
          <Link href="/leistungen" className="hover:text-secondary hover:underline">
            Leistungsübersicht
          </Link>
        </div>
      </div>
